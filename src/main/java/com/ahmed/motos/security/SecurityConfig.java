...
public class SecurityConfig {
	 ...
	 SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {      
		 	 http.authorizeHttpRequests((requests)->requests
	                		...
	                		.requestMatchers("/ListeMotos").hasAnyAuthority("ADMIN","AGENT","USER")
	 ...
	 * authorities("ADMIN") .build(); UserDetails userAhmed =
	 * User.withUsername("ahmed").password(passwordEncoder.encode("123"))
